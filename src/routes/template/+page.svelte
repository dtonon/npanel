	...
	<div slot="intro">
		<div class="w-full">
			<div class="border-l-[0.9rem] border-accent pl-4 sm:-ml-8 sm:mb-8">
				<h1 class="font-bold">
					<div class="text-[2rem] leading-[1em] text-neutral-500 sm:text-[2rem]">MY NOSTR</div>
					<div
						class="break-words text-[3.5rem] leading-[1em] text-black sm:h-auto sm:text-[3.5rem]"
						id="tw"
					>
						PROFILE
					</div>
