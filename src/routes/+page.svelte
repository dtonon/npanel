...
<div class="dark:bg-neutral-800">
	<div class="gradient max-h-max">
		<div class="flex min-h-screen items-center justify-center">
			<div class="mx-auto p-8 sm:w-[860px]">
				<!-- Welcome title -->
				<div class="mb-8 border-l-[0.9rem] border-accent pl-4 sm:-ml-8">
					<h1 class="font-bold">
						<div class="text-[2em] leading-[1em] sm:text-[3em] dark:text-neutral-400">
							YOUR
							<span class="text-accent">NOSTR</span>
						</div>
						<div
							class="break-words text-[3em] leading-[1em] sm:h-auto sm:text-[4em] dark:text-white"
							id="tw"
						>
							ACCOUNT<span class="text-neutral-500">&</span> BUNKER
						</div>
						<div
							class="text-[2em] leading-[1em] text-neutral-700 sm:text-[2.4em] dark:text-neutral-400"
						>
							MANAGER
						</div>
					</h1>
				...
				<!-- Join section -->
				<div class="my-8 border-t-4 pt-4 sm:my-14 dark:border-neutral-700">
					<div class="text-center text-[1.3rem] leading-7 text-neutral-700 dark:text-neutral-100">
